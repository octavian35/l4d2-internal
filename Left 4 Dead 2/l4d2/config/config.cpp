...
void config::load_cfg(const std::string& path)
{
	...
	g_var.m_aim_bot_var = load[X_("aimbot")][X_("enabled")].asBool();
	g_var.m_aim_fire_var = load[X_("aimbot")][X_("enabled")].asBool();
	g_var.m_aim_fov_var = load[X_("aimbot")][X_("fov")].asFloat();
	g_var.m_aim_compensation_var = load[X_("aimbot")][X_("recoil compensation")].asBool();
...
void config::save_cfg(const std::string& path)
{
	...
	Json::Value save;
	save[X_("aimbot")][X_("enabled")] = g_var.m_aim_bot_var;
	save[X_("aimbot")][X_("enabled")] = g_var.m_aim_fire_var;
	save[X_("aimbot")][X_("fov")] = g_var.m_aim_fov_var;
	save[X_("aimbot")][X_("recoil compensation")] = g_var.m_aim_compensation_var;
